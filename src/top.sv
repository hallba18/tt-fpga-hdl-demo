...
logic [0:0] FpgaPins_Fpga_CALC_valid_or_reset_a1;
   ...
   //
      ...
      //
         ...
         //
            ...
            // Staging of $digit.
            always_ff @(posedge clk) FpgaPins_Fpga_CALC_digit_a3[3:0] <= FpgaPins_Fpga_CALC_digit_a2[3:0];
      ...
      if (1) begin : \/fpga_pins 
         ...
         if (1) begin : \/fpga 
            ...
            if (1) begin : P_calc
               ...
               (* keep *) logic [0:0] \///@1$valid_or_reset ;
      ...
      //_/fpga_pins
         ...
         //_/fpga
            //_\source top.tlv 49   // Instantiated from /raw.githubusercontent.com/osfpga/VirtualFPGALab/a069f1e4e19adc829b53237b3e0b5d6763dc3194/tlvlib/fpgaincludes.tlv, 340 as: m4+calc.
               ...
               //_|calc
                  ...
                  //_@2
                     assign FpgaPins_Fpga_CALC_mem_a2[7:0] = FpgaPins_Fpga_CALC_reset_a2 ? 8'b0 :
                                 ~(FpgaPins_Fpga_CALC_valid_a2) & (FpgaPins_Fpga_CALC_op_a2 == 3'h5) ? FpgaPins_Fpga_CALC_val1_a2 : FpgaPins_Fpga_CALC_mem_a3;
                     assign FpgaPins_Fpga_CALC_out_a2[7:0] = FpgaPins_Fpga_CALC_reset_a2 ? 8'b0 :
                                 ...
                                 (FpgaPins_Fpga_CALC_op_a2 == 3'h4) ? FpgaPins_Fpga_CALC_mem_a4 :
                                 (FpgaPins_Fpga_CALC_op_a2 == 3'h3) ? FpgaPins_Fpga_CALC_quot_a2 :
                                 (FpgaPins_Fpga_CALC_op_a2 == 3'h2) ? FpgaPins_Fpga_CALC_prod_a2 :
                                 (FpgaPins_Fpga_CALC_op_a2 == 3'h1) ? FpgaPins_Fpga_CALC_diff_a2 :
                                 (FpgaPins_Fpga_CALC_op_a2 == 3'h0) ? FpgaPins_Fpga_CALC_sum_a2 : FpgaPins_Fpga_CALC_out_a4;
                     assign FpgaPins_Fpga_CALC_digit_a2[3:0] = FpgaPins_Fpga_CALC_out_a2[3:0];
                  //_@3
                     assign uo_out = (FpgaPins_Fpga_CALC_digit_a3 == 4'h0) ? 8'b00111111 :
               ...
               //_\source /raw.githubusercontent.com/efabless/chipcraftmestcourse/main/tlvlib/calculatorshelllib.tlv 4   // Instantiated from top.tlv, 99 as: m5+cal_viz(@2, /fpga)
                  // Only for Makerchip.
